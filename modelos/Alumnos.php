...
public function insertar($image,$name,$lastname,$email,$address,$phone,$c1_fullname,$c1_address,$c1_phone,$c1_note,$user_id,$team_id){
	$sql="INSERT INTO alumn (image,name,lastname,email,address,phone,c1_fullname,c1_address,c1_phone,c1_note,condicion,user_id)
...
public function listar($user_id, $team_id){
	$sql="SELECT a.id,a.image,a.name,a.lastname,a.email,a.address,a.phone,a.c1_fullname,a.c1_address,a.c1_phone,a.c1_note, a.condicion, a.user_id FROM alumn a INNER JOIN alumn_team alt ON a.id=alt.alumn_id WHERE a.condicion=1 AND a.user_id='$user_id' AND alt.team_id='$team_id' ORDER BY a.id DESC ";
	return ejecutarConsulta($sql);
}


public function verficar_alumno($user_id, $team_id){
	$sql="SELECT * FROM alumn a INNER JOIN alumn_team alt ON a.id=alt.alumn_id WHERE a.condicion=1 AND a.user_id='$user_id' AND alt.team_id='$team_id' ORDER BY a.id DESC ";
	return ejecutarConsultaSimpleFila($sql);
}
public function listar_calif($user_id, $team_id){
	$sql="SELECT a.id AS idalumn,a.image,a.name,a.lastname,a.email,a.address,a.phone,a.c1_fullname,a.c1_address,a.c1_phone,a.c1_note, a.condicion, a.user_id FROM alumn a INNER JOIN alumn_team alt ON a.id=alt.alumn_id WHERE a.condicion=1 AND a.user_id='$user_id' AND alt.team_id='$team_id' ORDER BY a.id DESC ";
	return ejecutarConsulta($sql); 
}
