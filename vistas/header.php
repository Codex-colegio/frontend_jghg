  ...
  (function(d, t) {
      ...
      v.onload = function() {
        window.voiceflow.chat.load({
          verify: { projectID: '67f6939667832ee5b54449f9' },
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>JGHG</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>JOSE GREGORIO HUAMAN GIRAO</b></span>
    </a>
...
if ($_SESSION['acceso']==1) {
  echo '  <li class="treeview">
        ...
        <li><a href="#" target="_blanck"><i class="fa  fa-exclamation-circle"></i> <span>Acerca de</span><small class="label pull-right bg-yellow">ComCod</small></a></li>   
